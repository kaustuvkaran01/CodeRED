...
router.post('/newToilet',  (req, res) => {
  const {lng, lat, restroomPrice, bathroomPrice, photos, hasToiletPaper, differentlyAbled, gender, landmarkName, toiletType} = req.body;
...
router.post("/newRating",   async (req, res) => {
    ...
    router.post("/oneToilet",   async (req, res)=>{
...
// router.get("/ownerToilets",  async (req, res) => {
//   try{
//     const toiletArray = await Toilet.find({
